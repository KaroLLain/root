...
def updateProduct(request, pk):
    ...
    product.lightRequirements = data['lightRequirements']
    product.countInStock = data['countInStock']
    product.watering = data['watering']
    product.plantSize = data['plantSize']
...
@api_view(['DELETE'])
@permission_classes([IsAdminUser])
def deleteProduct(request, pk): #pk - primary key
    product = Product.objects.get(_id=pk)
    product.delete()
